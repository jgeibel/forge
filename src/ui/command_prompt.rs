    ...
    fn register_default_commands(&mut self) {
        ...
        self.register_command(
            ...
            |args, world| {
                ...
                let mut query =
                    world.query_filtered::<&mut Transform, With<crate::camera::PlayerCamera>>();
        ...
        self.register_command(
            ...
            |args, world| {
                ...
                let level = match args[1].to_lowercase().as_str() {
                    ...
                    _ => {
                        return Err("Invalid permission level. Use: player, moderator, or admin"
                            .to_string())
                    }
                };
...
pub fn handle_command_input(
    ...
    for mut prompt in prompt_query.iter_mut() {
        ...
        let cursor = if (time.elapsed_seconds() * 2.0) as i32 % 2 == 0 {
            "_"
        } else {
            " "
        };
...
pub fn handle_mouse_scroll(
    ...
    for mut prompt in prompt_query.iter_mut() {
        ...
        for event in mouse_wheel.read() {
            ...
            prompt.scroll_position = (prompt.scroll_position + scroll_amount).clamp(-2000.0, 0.0); // Clamp between reasonable bounds
